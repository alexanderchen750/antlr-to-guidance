...
class ANTLRv4Parser ( Parser ):
    ...
    class PredicateOptionsContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterPredicateOptions" ):
                listener.enterPredicateOptions(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitPredicateOptions" ):
                listener.exitPredicateOptions(self)
    ...
    class PredicateOptionContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterPredicateOption" ):
                listener.enterPredicateOption(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitPredicateOption" ):
                listener.exitPredicateOption(self)
